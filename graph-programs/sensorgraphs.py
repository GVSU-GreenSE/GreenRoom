...
ax[0,0].set_xticks(np.arange(x_ticks[0], x_ticks[len(x_ticks) - 1] + 10, 10))    #Sets number of x-ticks
...
ax[0,1].set_xticks(np.arange(x_ticks[0], x_ticks[len(x_ticks) - 1] + 10, 10))    #Sets number of x-ticks
...
ax[1,0].set_xticks(np.arange(x_ticks[0], x_ticks[len(x_ticks) - 1] + 10, 10))    #Sets number of x-ticks
...
ax[1,1].set_xticks(np.arange(x_ticks[0], x_ticks[len(x_ticks) - 1] + 10, 10))    #Sets number of x-ticks
ax[1,1].set_yticks(np.arange(0, 90, 10))    #Sets number of y-ticks
ax[1,1].margins(x=0)

#Overall details
plt.suptitle("BME680 Sensor Data")
plt.figtext(x=0.45, y=0.92, s=formattimestamp)
plt.subplots_adjust(hspace=0.5)

#plt.show()
plt.savefig(timestamp + "_sensor_graph.png")