...
| ID | Requirement | Test Cases |
|:---:|:---:|:---:|
| R28 | The monitoring device cycles shall execute within \[time frame\] milliseconds. | TC28 |
| R29 | The test cases for the monitoring device shall execute within \[time frame\] milliseconds. | TC29 |
...
| TC10 | Temperature is greater than 85° Celsius | Set temperature to 95° C | temperature = 95 | "Temperature has exceeded 85° C. Temperature is outside the operational range for the BME680 sensor" printed to serial | TBD | TBD | R10 |
| TC11 | Temperature is less than 0° Celsius | Set temperature to -10° C | temperature = -10 | "Temperature is below 0° C. Temperature is outside the full accuracy range for the humidity and pressure sensors" printed to serial | TBD | TBD | R11 |
| TC12 | Temperature is less than -40° Celsius | Set temperature to -50° C | temperature = -50 | "Temperature is below -40° C. Temperature is outside the operational range for the BME680 sensor" printed to serial | TBD | TBD | R12 |
| TC13 | Humidity is between 10% and 90% relative humidity | Set humidity to 50% rh | humidity = 50 | "Humidity is within the full accuracy range for the humidity sensor" printed to serial | TBD | TBD | R13 |
| TC14 | Humidity is greater than 90% relative humidity | Set humidity to 92.5% rh | humidity = 92.5 | "Humidity has exceeded 90% rh. Humidity is outside the full accuracy range for the humidity sensor" printed to serial | TBD | TBD | R14 |
| TC15 | Humidity is greater than 95% relative humidity | Set humidity to 97.5% rh | humidity = 97.5 | "Humidity has exceeded 95% rh. Humidity is outside the operational range for the gas sensor" printed to serial | TBD | TBD | R15 |
| TC16 | Humidity is less than 10% relative humidity | Set humidity to 5% rh | humidity = 5 | "Humidity is below 10% rh. Humidity is outside the operational range for the gas sensor" printed to serial | TBD | TBD | R16 |
| TC17 | Pressure is between 8.85899 and 32.48298 inches of mercury | Set pressure to 20 inHg | pressure = 20 | "Pressure is within the full accuracy range for the pressure sensor" printed to serial | TBD | TBD | R17 |
| TC18 | Pressure is less than 8.85899 inches of mercury | Set pressure to 5 inHg | pressure = 5 | "Pressure is below the full accuracy range for the pressure sensor" | TBD | TBD | R18 |
| TC19 | Pressure is greater than 32.48298 inches of mercury | Set pressure to 35 inHg | pressure = 35 | "Pressure exceeds the full accuracy range for the pressure sensor" | TBD | TBD | R19 |
| TC20 | Sensor readings are taken every \[timeunit\] | Run bme680_v3, monitor serial output | N/A | | TBD | TBD | R20 |
| TC21 | Test harness cannot interfere with power consumption of the monitoring device | Run poweronly.py with USB connection between monitoring device and test harness, then without USB connection, monitor outputs and compare | N/A | Power consumption does not change whether USB connection exists or not | TBD | TBD | R21 |
| TC22 | Test harness logs sensor data into CSV file | Run arduinopower.log, upon completion check for presence of sensor-data CSV file | N/A | Timestamped sensor-data CSV file | TBD | TBD | R22 |
| TC23 | Test harness logs power consumption data into CSV file | Run arduinopowerlog.py, upon completion check for presence of power-data CSV file | N/A | Timestamped power-data CSV file | TBD | TBD | R23 |
| TC24 | Test harness generates graphs of the sensor data | Run sensorgraphs.py, visually confirm graph | N/A | Graph | TBD | TBD | R24 |
| TC25 | Test harness generates graphs of the power consumption data | Run powergraphs.py, visually confirm graph | N/A | Graph | TBD | TBD | R25 |
| TC26 | Test harness receives data from monitoring device via serial | Run arduinopowerlog.py, monitor printed output | N/A | On-screen output | TBD | TBD | R26 |
| TC27 | Power consumption readings are taken every \[time unit\] | Run arduinopowerlog.py, compare timestamp | \[time unit\] within <x> milliseconds | N/A | TBD | TBD | R27 |
| TC28 | Monitoring device cycles will execute within \[time\] milliseconds | Run bme680_v3, monitor timestamps | N/A | \[time\] milliseconds | TBD | TBD | R28 |
| TC29 | Non-visual test cases for monitoring device will execute within \[time unit\] milliseconds| Run several test cases, monitor timestamps | N/A | \[time\] milliseconds | TBD | TBD | R29 |
